...
export function LandingHowItWorks() {
  ...
  const steps = [
    {
      number: '01',
      title: 'Daftar & Pilih Tipe Akun',
      desc: 'Buat akun gratis dalam 2 menit. Pilih Personal (keuangan pribadi) atau Bisnis (UMKM). Wizard 3-langkah memandu setup awal — pilih fitur apa yang Anda butuhkan, aktifkan/nonaktifkan inventaris, hutang-piutang, dll.',
      detail: 'Personal & Bisnis tersedia',
    ...
    },
    {
      ...
      desc: 'Buka Pengaturan → masukkan Telegram ID Anda (dapatkan dari @userinfobot). Bot langsung mengenali Anda. Satu akun bisa kelola banyak bisnis — gunakan /switch untuk pindah.',
    ...
    {
      number: '03',
      title: 'Catat & Kelola Semua Lewat Chat',
      desc: 'Kirim pesan natural, foto struk, rekam suara, atau input manual. Salah input? Cukup ketik "eh salah, harusnya 9.5jt". AI koreksi langsung. Buat goals, catat hutang, kelola stok — semua bisa lewat chat.',
      detail: 'Edit/undo via chat',
    ...
    },
    {
      ...
      desc: 'Dashboard real-time dengan filter per bulan/tahun. Tanya AI berapa keuntungan atau kapan bisnis paling ramai. Export PDF langsung dari Telegram dengan /pdf kapan saja.',
